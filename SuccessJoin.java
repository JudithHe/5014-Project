...
public class Nation {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<String> orders = env.readTextFile("/Users/judith/Project/StreamingData/data/orders.csv");
		DataStream<String> lineitem = env.readTextFile("/Users/judith/Project/StreamingData/data/lineitem.csv");
		//lineitem.print();
		...
		Date DATE = sdformat.parse("1995-03-13");
		...
		SingleOutputStreamOperator<Tuple11<Integer, String, String, Integer, String, Double, String, String, Integer, Double, Double>> combined 
	...
	public static class JoinNCO_Lineitem extends CoProcessFunction<Tuple9<Integer, String, String, Integer, String, Double, String, String, Integer>,
		...
		@Override
		public void processElement1(Tuple9<Integer, String, String, Integer, String, Double, String, String, Integer> value, CoProcessFunction<Tuple9<Integer, String, String, Integer, String, Double, String, String, Integer>, Tuple4<Integer, Double, Double, String>, Tuple11<Integer, String, String, Integer, String, Double, String, String, Integer, Double, Double>>.Context ctx, Collector<Tuple11<Integer, String, String, Integer, String, Double, String, String, Integer, Double, Double>> out) throws Exception {
		...
		@Override
		public void processElement2(Tuple4<Integer, Double, Double, String> value, CoProcessFunction<Tuple9<Integer, String, String, Integer, String, Double, String, String, Integer>, Tuple4<Integer, Double, Double, String>, Tuple11<Integer, String, String, Integer, String, Double, String, String, Integer, Double, Double>>.Context ctx, Collector<Tuple11<Integer, String, String, Integer, String, Double, String, String, Integer, Double, Double>> out) throws Exception {
	...
	public static class JoinNC_Order extends CoProcessFunction<Tuple8<Integer, String, String, Integer, String, Double, String, String>,
		...
		@Override
		public void processElement1(Tuple8<Integer, String, String, Integer, String, Double, String, String> value, CoProcessFunction<Tuple8<Integer, String, String, Integer, String, Double, String, String>, Tuple3<Integer, Integer, Date>, Tuple9<Integer, String, String, Integer, String, Double, String, String, Integer>>.Context ctx, Collector<Tuple9<Integer, String, String, Integer, String, Double, String, String, Integer>> out) throws Exception {
		...
		@Override
		public void processElement2(Tuple3<Integer, Integer, Date> value, CoProcessFunction<Tuple8<Integer, String, String, Integer, String, Double, String, String>, Tuple3<Integer, Integer, Date>, Tuple9<Integer, String, String, Integer, String, Double, String, String, Integer>>.Context ctx, Collector<Tuple9<Integer, String, String, Integer, String, Double, String, String, Integer>> out) throws Exception {
